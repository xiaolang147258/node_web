<template>
   ...
   <div style="width:100%;float: left;">
	<el-table ref="multipleTable" :data="tableData3" tooltip-effect="dark" style="width: 100%">
       ...
       <el-table-column prop="order.street_name" align='center' header-align='center' label="街道" ></el-table-column>
	   ...
	   <!-- <el-table-column prop="classes.course_title" align='center' header-align='center' label="课程名称" show-overflow-tooltip></el-table-column> -->
	   <el-table-column prop="classes.class_name" align='center' header-align='center' label="课班名称" show-overflow-tooltip></el-table-column>
	   ...
	   <el-table-column prop="order.server_name" class='tds' align='center' header-align='center'  label="所属机构" show-overflow-tooltip></el-table-column>
	   <el-table-column prop="student.contact1_name" class='tds' align='center' header-align='center'  label="家长姓名" show-overflow-tooltip></el-table-column>
	   <el-table-column prop="student.contact1_phone" class='tds' align='center' header-align='center'  label="家长电话" show-overflow-tooltip></el-table-column>
