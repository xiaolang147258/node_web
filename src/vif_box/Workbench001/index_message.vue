<template>
   ...
   <div style="width:100%;float: left;">
	<el-table ref="multipleTable" :data="tableData3" tooltip-effect="dark" style="width: 100%"@selection-change="handleSelectionChange">
	   ...
	   <el-table-column prop="school_name" class='tds' align='center' header-align='center'  label="所在学校" show-overflow-tooltip></el-table-column>
       ...
       <el-table-column  label="操作" align='center' header-align='center'>
		   <template slot-scope="scope">
			  <el-button @click='xiang("put",scope.row.message_id,scope.row)' type="primary" :loading="btn_log" plain>详情</el-button>
...
<el-dialog :title="message_title" :visible.sync="dialogTableVisible">
  <textarea v-model="textareax" cols="30" rows="10" maxlength="500" style="width:100%;height:300px;border:1px solid #dcdfe6;border-radius:3px;padding:10px;" placeholder="请输入内容(不超过500字)"></textarea>
